...
export class ProfileComponent implements OnInit {
  ...
  apiUrl = 'https://todoapp-be-3gho.onrender.com/api/todos/getuser'; // API endpoint to fetch user details
  delUrl= 'https://todoapp-be-3gho.onrender.com/api/todos/deleteuser'
